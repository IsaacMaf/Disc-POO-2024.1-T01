# Disciplina de POO INFO - P3 Trabalho 01.
## professor: Roger.
...
### QR09: Faça um programa que calcule e mostre a área de um triângulo. Sabe-se que: Área = (base * altura)/2.
...
### QR13: Faça um programa que receba uma medida em pés, faça as conversões a seguir e mostre os resultados.
### a) polegadas;
### b) jardas;
### c) milhas.
